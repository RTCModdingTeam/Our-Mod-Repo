...
import net.minecraft.src.CallableEffectAmplifier;
import net.minecraft.src.CallableEffectDuration;
import net.minecraft.src.CallableEffectID;
import net.minecraft.src.CallableEffectIsAmbient;
import net.minecraft.src.CallableEffectIsSplash;
import net.minecraft.src.CallableEffectName;
...
public abstract class EntityLiving extends Entity {
   ...
   private static final float[] field_82176_d = new float[]{0.0F, 0.0F, 0.05F, 0.07F};
