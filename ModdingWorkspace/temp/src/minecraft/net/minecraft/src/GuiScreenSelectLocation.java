...
public abstract class GuiScreenSelectLocation {
   ...
   public GuiScreenSelectLocation(Minecraft p_i23001_1_, int p_i23001_2_, int p_i23001_3_, int p_i23001_4_, int p_i23001_5_, int p_i23001_6_) {
      this.field_104092_f = p_i23001_1_;
      this.field_104093_g = p_i23001_2_;
      this.field_104105_h = p_i23001_3_;
      this.field_104098_a = p_i23001_4_;
      this.field_104096_b = p_i23001_5_;
      this.field_104097_c = p_i23001_6_;
      this.field_104103_j = 0;
      this.field_104106_i = p_i23001_2_;
   }
   ...
   public int func_104085_d() {
      return this.func_77212_b() - (this.field_104096_b - this.field_104098_a - 4);
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
         ...
         if(this.field_104102_m == -1.0F) {
            ...
            if(p_73863_2_ >= this.field_104098_a && p_73863_2_ <= this.field_104096_b) {
               ...
               if(p_73863_1_ >= var5 && p_73863_1_ <= var6) {
                  ...
                  var13 = (int)((float)((this.field_104096_b - this.field_104098_a) * (this.field_104096_b - this.field_104098_a)) / (float)this.func_77212_b());
                  if(var13 < 32) {
                     var13 = 32;
                  }
      ...
      this.field_104092_f.field_71446_o.func_98187_b("/gui/background.png");
      ...
      var19 = this.func_104085_d();
      if(var19 > 0) {
         var13 = (this.field_104096_b - this.field_104098_a) * (this.field_104096_b - this.field_104098_a) / this.func_77212_b();
         if(var13 < 32) {
            var13 = 32;
         }
