...
public class ItemRenderer {
   ...
   public void func_78443_a(EntityLiving p_78443_1_, ItemStack p_78443_2_, int p_78443_3_) {
      ...
      if(p_78443_2_.func_94608_d() == 0 && var4 != null && RenderBlocks.func_78597_b(var4.func_71857_b())) {
         ...
         func_78439_a(var6, var8, var9, var7, var10, var5.func_94213_j(), var5.func_94208_k(), 0.0625F);
   ...
   public void func_78440_a(float p_78440_1_) {
      ...
      float var16;
      RenderPlayer var18;
      if(var7 != null && var7.field_77993_c == Item.field_77744_bd.field_77779_bT) {
         GL11.glPushMatrix();
         var6 = 0.8F;
         ...
         var25.func_78382_b();
         byte var23 = 7;
         var25.func_78374_a((double)(0 - var23), (double)(128 + var23), 0.0D, 0.0D, 1.0D);
         var25.func_78374_a((double)(128 + var23), (double)(128 + var23), 0.0D, 1.0D, 1.0D);
         var25.func_78374_a((double)(128 + var23), (double)(0 - var23), 0.0D, 1.0D, 0.0D);
         var25.func_78374_a((double)(0 - var23), (double)(0 - var23), 0.0D, 0.0D, 0.0D);
         var25.func_78381_a();
         MapData var27 = Item.field_77744_bd.func_77873_a(var7, this.field_78455_a.field_71441_e);
         if(var27 != null) {
            this.field_78449_f.func_78319_a(this.field_78455_a.field_71439_g, this.field_78455_a.field_71446_o, var27);
         }
         ...
         if(var3.func_71052_bv() > 0) {
            ...
            if(var21 == EnumAction.block) {
               ...
               if(var22 > 0.1F) {
                  GL11.glTranslatef(0.0F, MathHelper.func_76126_a((var16 - 0.1F) * 1.3F) * 0.01F * (var22 - 0.1F), 0.0F);
               }
         ...
         if(var7.func_77973_b().func_77623_v()) {
            ...
            int var26 = Item.field_77698_e[var7.field_77993_c].func_82790_a(var7, 1);
