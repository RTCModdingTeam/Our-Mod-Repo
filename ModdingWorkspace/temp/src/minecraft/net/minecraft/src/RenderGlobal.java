...
public class RenderGlobal implements IWorldAccess {
   ...
   public void func_72713_a(Vec3 p_72713_1_, ICamera p_72713_2_, float p_72713_3_) {
      if(this.field_72740_G > 0) {
         ...
         RenderManager.field_78727_a.func_78718_a(this.field_72769_h, this.field_72770_i, this.field_72777_q.field_71466_p, this.field_72777_q.field_71451_h, this.field_72777_q.field_96291_i, this.field_72777_q.field_71474_y, p_72713_3_);
   ...
   public void func_72714_a(float p_72714_1_) {
      if(this.field_72777_q.field_71441_e.field_73011_w.field_76574_g == 1) {
         ...
         RenderHelper.func_74518_a();
         GL11.glDepthMask(false);
         this.field_72770_i.func_98187_b("/misc/tunnel.png");
         ...
         var12 = 30.0F;
         this.field_72770_i.func_98187_b("/environment/sun.png");
         var23.func_78382_b();
         ...
         var23.func_78381_a();
         var12 = 20.0F;
         this.field_72770_i.func_98187_b("/environment/moon_phases.png");
   ...
   public void func_72718_b(float p_72718_1_) {
      if(this.field_72777_q.field_71441_e.field_73011_w.func_76569_d()) {
         if(this.field_72777_q.field_71474_y.field_74347_j) {
            ...
            int var4 = 256 / var3;
            Tessellator var5 = Tessellator.field_78398_a;
            this.field_72770_i.func_98187_b("/environment/clouds.png");
            GL11.glEnable(3042);
            GL11.glBlendFunc(770, 771);
   ...
   public void func_72727_a(EntityPlayer p_72727_1_, MovingObjectPosition p_72727_2_, int p_72727_3_, ItemStack p_72727_4_, float p_72727_5_) {
      ...
      if(p_72727_3_ != 0 && p_72727_4_ != null) {
         ...
         this.field_72770_i.func_98187_b("/terrain.png");
      }
         ...
         if(var21 != null) {
            ...
            if(var15 * var15 + var17 * var17 + var19 * var19 > var22 * var22) {
               ...
               if(p_72726_1_.equals("bubble")) {
                  ...
                  var21 = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, Item.field_77768_aD, this.field_72770_i);
                  ...
                  var21 = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, Item.field_77761_aM, this.field_72770_i);
                  ...
                  var21 = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Item.field_77698_e[var27], this.field_72770_i);
                  ...
                  var21 = (new EntityDiggingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Block.field_71973_m[var25], 0, var26, this.field_72770_i)).func_90019_g(var26);
               }
   ...
   public void func_94140_a(IconRegister p_94140_1_) {
      ...
      for(int var2 = 0; var2 < this.field_94141_F.length; ++var2) {
         this.field_94141_F[var2] = p_94140_1_.func_94245_a("destroy_" + var2);
      }
