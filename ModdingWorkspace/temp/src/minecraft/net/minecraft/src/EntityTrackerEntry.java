...
import net.minecraft.src.EntityTrackerNonliving;
...
public class EntityTrackerEntry {
   ...
   private Packet func_73124_b() {
      ...
      if(this.field_73132_a instanceof EntityItem) {
         ...
         return new Packet23VehicleSpawn(this.field_73132_a, 10, var10.func_94087_l());
         ...
         if(this.field_73132_a instanceof EntityFishHook) {
            ...
            Entity var5 = ((EntityArrow)this.field_73132_a).field_70250_c;
            return new Packet23VehicleSpawn(this.field_73132_a, 60, var5 != null?var5.field_70157_k:this.field_73132_a.field_70157_k);
            ...
            if(this.field_73132_a instanceof EntityFireball) {
               ...
               if(var7.field_70235_a != null) {
                  var1 = new Packet23VehicleSpawn(this.field_73132_a, var9, ((EntityFireball)this.field_73132_a).field_70235_a.field_70157_k);
               } else {
                  var1 = new Packet23VehicleSpawn(this.field_73132_a, var9, 0);
               }

               var1.field_73523_e = (int)(var7.field_70232_b * 8000.0D);
               var1.field_73520_f = (int)(var7.field_70233_c * 8000.0D);
               var1.field_73521_g = (int)(var7.field_70230_d * 8000.0D);
               return var1;
               ...
               EntityFallingSand var6 = (EntityFallingSand)this.field_73132_a;
               return new Packet23VehicleSpawn(this.field_73132_a, 70, var6.field_70287_a | var6.field_70285_b << 16);
               ...
               var1 = new Packet23VehicleSpawn(this.field_73132_a, 71, var4.field_82332_a);
               var1.field_73524_b = MathHelper.func_76141_d((float)(var4.field_70523_b * 32));
               var1.field_73525_c = MathHelper.func_76141_d((float)(var4.field_70524_c * 32));
               var1.field_73522_d = MathHelper.func_76141_d((float)(var4.field_70521_d * 32));
               return var1;
               ...
               } while(!var3.entityClass.isAssignableFrom(this.field_73132_a.getClass()));

               return var3.mod.getSpawnPacket(this.field_73132_a, var3.id);
            }
         }
      } else {
